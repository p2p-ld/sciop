...
def upgrade() -> None:
    ...
    with op.batch_alter_table("accounts", schema=None) as batch_op:
        batch_op.add_column(sa.Column("is_suspended", sa.Boolean(), nullable=False, default=False))
    ...
    with op.batch_alter_table("dataset_parts", schema=None) as batch_op:
        batch_op.add_column(sa.Column("is_removed", sa.Boolean(), nullable=False, default=False))
